 ...
 * @author b.zraier
 */
public class ArticleDoc extends BaseForm {

    public ArticleDoc(Resources res) {
        ...
        for (int i =0 ; i<as.afficheArticle().size();i++){
             addButton(res.getImage(as.afficheArticle().get(i).getImage()), as.afficheArticle().get(i).getArticle(), false, 26, 32);
        }
